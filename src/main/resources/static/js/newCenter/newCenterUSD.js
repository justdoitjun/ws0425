 let newCenterUSD={
    init:()=>{
    newCenterUSD.getData();
    setInterval(newCenterUSD.getData, 5000);
},//newCenterUSD-init
    getData:()=>{
    $.ajax({
    url:'/getdata01'
    ...
    detailChart = Highcharts.chart('c1', {
    chart: {
    marginBottom: 120,
    reflow: false,
    marginLeft: 50,
    ...
    title: {
    text: 'Real-time Fixed-Asset Bid Rate',
    align: 'left'
},
    subtitle: {
